...
const envSchema = z.object({
  ...
  INGEST_API_KEYS: z.string().default('org_acme:dev-api-key'),
  INGEST_RATE_LIMIT_RATE: z.coerce.number().default(10),
  INGEST_RATE_LIMIT_INTERVAL_MS: z.coerce.number().default(1000),
  DELIVERY_WORKER_PORT: z.coerce.number().default(3002),
  DELIVERY_HMAC_SECRET: z.string().default('dev-secret'),
  DELIVERY_CONCURRENCY: z.coerce.number().default(5),
